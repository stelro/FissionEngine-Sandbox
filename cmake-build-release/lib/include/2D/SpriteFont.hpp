...
#ifndef PROJECT_SPRITEFONT_HPP
#define PROJECT_SPRITEFONT_HPP
...
#define LAST_PRINTABLE_CHAR ((char)126)
    ...
    public:
        ...
        void startUp(const char* font, int size, char cs, char ce);
        void startUp(const char* font, int size);
