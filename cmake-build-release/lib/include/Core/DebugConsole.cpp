...
namespace Fiene {
    ...
    void DebugConsole::Draw(const char *title, bool *p_open)
    {
        ...
        ImGui::TextWrapped("Fission Engine Debug/Log Console");
    ...
    int DebugConsole::Stricmp(const char *str1, const char *str2)
    {
        int d;
    ...
    int DebugConsole::Strnicmp(const char *str1, const char *str2, int n)
    {
        int d = 0;
    ...
    char *DebugConsole::Strdup(const char *str)
    {
        ...
        switch (data->EventFlag)
        {
            case ImGuiInputTextFlags_CallbackCompletion:
            {
                ...
                if (candidates.Size == 0) {
                     ...
                     * so inputing "C" will complete to "CL" and display "CLEAR" and "CLASSIFY" */
